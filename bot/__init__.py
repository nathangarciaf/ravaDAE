...
print("")
print("""OLÁ, MEU NOME É rAVA, OBRIGADO POR FAZER PARTE DE NOSSO TESTE. 
    SE QUISER CONTRIBUIR COM NOSSA BASE DE CONHECIMENTO OFICIAL, 
    ENVIE ALGUMAS PERGUNTAS PARA https://forms.gle/xKcz1BSJbVam8sJ19
